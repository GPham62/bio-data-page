...
export const axisStrong  = { tick: { fill: COLORS.tickStrong, fontSize: 10 }, axisLine: false, tickLine: false }
export const axisStrong11 = { tick: { fill: COLORS.tickStrong, fontSize: 11 }, axisLine: false, tickLine: false }
