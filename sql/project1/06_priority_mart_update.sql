-- Incremental update: MERGE keeps priority_jobs_snapshot current without a full reload
...
WHEN NOT MATCHED THEN
    ...
    VALUES (src.job_id, src.job_title_short, src.company_name, src.job_posted_date,
            src.salary_year_avg, src.priority_lvl, src.updated_at)
WHEN NOT MATCHED BY SOURCE THEN DELETE;

-- Verify
SELECT job_title_short, COUNT(*) AS job_count, MIN(priority_lvl) AS priority_lvl,
